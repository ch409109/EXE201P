...
namespace ClickCart.Migrations
{
    ...
    [Migration("20250218040634_UpdateUser")]
            ...
            modelBuilder.Entity("ClickCart.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OrderID = 1,
                            CreatedAt = new DateTime(2025, 2, 13, 11, 6, 34, 122, DateTimeKind.Local).AddTicks(8846),
                        ...
                        {
                            OrderID = 2,
                            CreatedAt = new DateTime(2025, 2, 15, 11, 6, 34, 122, DateTimeKind.Local).AddTicks(8855),
                        ...
                        {
                            OrderID = 3,
                            CreatedAt = new DateTime(2025, 2, 17, 11, 6, 34, 122, DateTimeKind.Local).AddTicks(8857),
            ...
            modelBuilder.Entity("ClickCart.Models.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            UserID = 1,
                            CreatedAt = new DateTime(2025, 2, 18, 11, 6, 32, 900, DateTimeKind.Local).AddTicks(8863),
                            Email = "HaiLTHE172555@fpt.edu.vn",
                            FreeShipCount = 0,
                            FullName = "Lại Tuấn Hai",
                            PasswordHash = "$2a$11$Ta4VCR7JSBP0F4hWaCOdb.owv/XsttWjhL/wQ280nZq7K7pF8ocPK",
                            PhoneNumber = "0123456789",
                            Role = "Admin",
                            Username = "HaiAdmin"
                        },
                        ...
                        {
                            UserID = 2,
                            CreatedAt = new DateTime(2025, 2, 18, 11, 6, 33, 44, DateTimeKind.Local).AddTicks(2984),
                            Email = "HungPVHE161180@fpt.edu.vn",
                            FreeShipCount = 0,
                            FullName = "Phạm Việt Hưng",
                            PasswordHash = "$2a$11$VQBbNo9OUpC4H5Z.pkoVie6HNpjNbqrtLPhGbfgi7timT60y22BX2",
                            PhoneNumber = "0123456789",
                            Role = "Admin",
                            Username = "HungAdmin"
                        },
                        ...
                        {
                            UserID = 3,
                            CreatedAt = new DateTime(2025, 2, 18, 11, 6, 33, 188, DateTimeKind.Local).AddTicks(317),
                            Email = "CongHTHE172673@fpt.edu.vn",
                            FreeShipCount = 0,
                            FullName = "Hoàng Thành Công",
                            PasswordHash = "$2a$11$r1tOUCLYTqVC5ulIrvgvteGyirMtY29M8vTbni.jw9vQuxPndCTGK",
                            PhoneNumber = "0123456789",
                            Role = "Admin",
                            Username = "CongAdmin"
                        },
                        ...
                        {
                            UserID = 4,
                            CreatedAt = new DateTime(2025, 2, 18, 11, 6, 33, 331, DateTimeKind.Local).AddTicks(2027),
                            Email = "NhatLVHE176909@fpt.edu.vn",
                            FreeShipCount = 0,
                            FullName = "Lê Việt Nhật",
                            PasswordHash = "$2a$11$q5w6c81xEvXPbPFiYwo/0.D9u.pLLP3y8xXcWGPXwAyJdDc0O6WEu",
                            PhoneNumber = "0123456789",
                            Role = "Admin",
                            Username = "NhatAdmin"
                        },
                        ...
                        {
                            UserID = 5,
                            CreatedAt = new DateTime(2025, 2, 18, 11, 6, 33, 474, DateTimeKind.Local).AddTicks(8024),
                            Email = "TrongLCPHS176090@fpt.edu.vn",
                            FreeShipCount = 0,
                            FullName = "Lê Công Phú Trọng",
                            PasswordHash = "$2a$11$1u8tHxiZDdfKWhoL3ck6Cew47hSjmikyrMncsidwbZtT6k.jNOoSW",
                            PhoneNumber = "0123456789",
                            Role = "Admin",
                            Username = "TrongAdmin"
                        },
                        ...
                        {
                            UserID = 6,
                            CreatedAt = new DateTime(2025, 2, 18, 11, 6, 33, 618, DateTimeKind.Local).AddTicks(2250),
                            Email = "DatVTHS176109@fpt.edu.vn",
                            FreeShipCount = 0,
                            FullName = "Vũ Tiến Đạt",
                            PasswordHash = "$2a$11$5qhMuQ8MKlDClfVQJgPfXufmDa2nz3951/s/lbLV.YH5mAElQ1p6W",
                            PhoneNumber = "0123456789",
                            Role = "Admin",
                            Username = "DatAdmin"
                        },
                        ...
                        {
                            UserID = 7,
                            CreatedAt = new DateTime(2025, 2, 18, 11, 6, 33, 750, DateTimeKind.Local).AddTicks(1971),
                            Email = "TungNVHE170677@fpt.edu.vn",
                            FreeShipCount = 0,
                            FullName = "Nguyễn Việt Tùng",
                            PasswordHash = "$2a$11$eJyOe6w6KwTgo3TLi8RKM.xTzgDV64hEGkdiSNG/VUVuGlv8Vvl3m",
                        ...
                        {
                            UserID = 8,
                            CreatedAt = new DateTime(2025, 2, 18, 11, 6, 33, 873, DateTimeKind.Local).AddTicks(8215),
                            Email = "ToanPMHE171369@fpt.edu.vn",
                            FreeShipCount = 0,
                            FullName = "Phan Mạnh Toàn",
                            PasswordHash = "$2a$11$IMjet6iByzzIdOdaMs1/au5uXxZwJ7QlPaTfnxyqenQHXGG9BS2Ne",
                            PhoneNumber = "0987654321",
                            Role = "Customer",
                            Username = "ToanUser"
                        },
                        ...
                        {
                            UserID = 9,
                            CreatedAt = new DateTime(2025, 2, 18, 11, 6, 33, 998, DateTimeKind.Local).AddTicks(1933),
                            Email = "CuongPXHE172287@fpt.edu.vn",
                            FreeShipCount = 0,
                            FullName = "Phạm Xuân Cường",
                            PasswordHash = "$2a$11$6B/VtGYtLMZ72VW8YdYhauZ4ossyyAaOmZIfymtR30sjjxrRIshDu",
                            PhoneNumber = "0987654321",
                            Role = "Customer",
                            Username = "CuongUser"
                        },
                        ...
                        {
                            UserID = 10,
                            CreatedAt = new DateTime(2025, 2, 18, 11, 6, 34, 122, DateTimeKind.Local).AddTicks(7882),
                            Email = "AnhVNHE151076@fpt.edu.vn",
                            FreeShipCount = 0,
                            FullName = "Vũ Nam Anh",
                            PasswordHash = "$2a$11$2Gmr32UEp1FX2SaVVQijDekAr0BH9tfK6oCSucqWog3qTecPKQ5Yu",
                            PhoneNumber = "0123456789",
                            Role = "Customer",
                            Username = "AnhUser"
                        });
