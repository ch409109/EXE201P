...
namespace ClickCart.Migrations
{
    ...
    [Migration("20250213163416_UpdateDatabase")]
            ...
            modelBuilder.Entity("ClickCart.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            OrderID = 1,
                            CreatedAt = new DateTime(2025, 2, 8, 23, 34, 15, 514, DateTimeKind.Local).AddTicks(7960),
                        ...
                        {
                            OrderID = 2,
                            CreatedAt = new DateTime(2025, 2, 10, 23, 34, 15, 514, DateTimeKind.Local).AddTicks(7972),
                            PaymentGateway = "COD",
                        ...
                        {
                            OrderID = 3,
                            CreatedAt = new DateTime(2025, 2, 12, 23, 34, 15, 514, DateTimeKind.Local).AddTicks(7973),
            ...
            modelBuilder.Entity("ClickCart.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("FreeShipEndDate")
                        .HasColumnType("datetime2");

                    b.Property<DateTime?>("FreeShipStartDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasData(
                        ...
                        {
                            UserID = 1,
                            CreatedAt = new DateTime(2025, 2, 13, 23, 34, 14, 202, DateTimeKind.Local).AddTicks(9135),
                            Email = "HaiLTHE172555@fpt.edu.vn",
                            FullName = "Lại Tuấn Hai",
                            IsFreeShip = false,
                            PasswordHash = "$2a$11$j8zN5h5padIIQcPu3Dyqc.2g497eHhacNQTdK0owet18FbK2UmjGS",
                        ...
                        {
                            UserID = 2,
                            CreatedAt = new DateTime(2025, 2, 13, 23, 34, 14, 353, DateTimeKind.Local).AddTicks(9542),
                            Email = "HungPVHE161180@fpt.edu.vn",
                            FullName = "Phạm Việt Hưng",
                            IsFreeShip = false,
                            PasswordHash = "$2a$11$1ev6fA7mcX245GjmrWyNF.bZ6Rw.kvavI7pXW./r41b1LBzwE4jOi",
                            PhoneNumber = "0123456789",
                            Role = "Admin",
                            Username = "HungAdmin"
                        },
                        ...
                        {
                            UserID = 3,
                            CreatedAt = new DateTime(2025, 2, 13, 23, 34, 14, 499, DateTimeKind.Local).AddTicks(2000),
                            Email = "CongHTHE172673@fpt.edu.vn",
                            FullName = "Hoàng Thành Công",
                            IsFreeShip = false,
                            PasswordHash = "$2a$11$F7x57q5KHYhGsWIT0kjgC.keUQnwcBK0TfZWJ3YxR4op3ukHVgpoy",
                            PhoneNumber = "0123456789",
                            Role = "Admin",
                            Username = "CongAdmin"
                        },
                        ...
                        {
                            UserID = 4,
                            CreatedAt = new DateTime(2025, 2, 13, 23, 34, 14, 642, DateTimeKind.Local).AddTicks(772),
                            Email = "NhatLVHE176909@fpt.edu.vn",
                            FullName = "Lê Việt Nhật",
                            IsFreeShip = false,
                            PasswordHash = "$2a$11$98OYMCSuLCytKASjEM8xr.gz8NcP4NNHlVRRBzAS/QEE37sjva2AW",
                            PhoneNumber = "0123456789",
                            Role = "Admin",
                            Username = "NhatAdmin"
                        },
                        ...
                        {
                            UserID = 5,
                            CreatedAt = new DateTime(2025, 2, 13, 23, 34, 14, 778, DateTimeKind.Local).AddTicks(7863),
                            Email = "TrongLCPHS176090@fpt.edu.vn",
                            FullName = "Lê Công Phú Trọng",
                            IsFreeShip = false,
                            PasswordHash = "$2a$11$qu7PHCHaUr.HBZE0oEgmL.O7Z04uCtR.tVkmdbextNmi/4LoQAVFG",
                            PhoneNumber = "0123456789",
                            Role = "Admin",
                            Username = "TrongAdmin"
                        },
                        ...
                        {
                            UserID = 6,
                            CreatedAt = new DateTime(2025, 2, 13, 23, 34, 14, 923, DateTimeKind.Local).AddTicks(8545),
                            Email = "DatVTHS176109@fpt.edu.vn",
                            FullName = "Vũ Tiến Đạt",
                            IsFreeShip = false,
                            PasswordHash = "$2a$11$KBRdZlmYzrdzH7u8HSjVDOH7cbRc.YDbY.Qv91bl1CupGZDN9Fmwa",
                            PhoneNumber = "0123456789",
                            Role = "Admin",
                            Username = "DatAdmin"
                        },
                        ...
                        {
                            UserID = 7,
                            CreatedAt = new DateTime(2025, 2, 13, 23, 34, 15, 72, DateTimeKind.Local).AddTicks(3260),
                            Email = "TungNVHE170677@fpt.edu.vn",
                            FullName = "Nguyễn Việt Tùng",
                            IsFreeShip = false,
                            PasswordHash = "$2a$11$28n.TOHOUk1r0.71PSyLAe85EBpsHzYAGA4vx95EQ3HuLkeIH8.Km",
                        ...
                        {
                            UserID = 8,
                            CreatedAt = new DateTime(2025, 2, 13, 23, 34, 15, 214, DateTimeKind.Local).AddTicks(4172),
                            Email = "ToanPMHE171369@fpt.edu.vn",
                            FullName = "Phan Mạnh Toàn",
                            IsFreeShip = false,
                            PasswordHash = "$2a$11$mNsBFCt8zBmelE9RLuQhFu7gU43ajYtWqwCnJNPZwYMPOI4251gM2",
                            PhoneNumber = "0987654321",
                            Role = "Customer",
                            Username = "ToanUser"
                        },
                        ...
                        {
                            UserID = 9,
                            CreatedAt = new DateTime(2025, 2, 13, 23, 34, 15, 367, DateTimeKind.Local).AddTicks(1290),
                            Email = "CuongPXHE172287@fpt.edu.vn",
                            FullName = "Phạm Xuân Cường",
                            IsFreeShip = false,
                            PasswordHash = "$2a$11$OJbayYC5G/X27iOtEk4sMOxTvei4fSHHSudNRLgkyDYeY9H.ygZzO",
                            PhoneNumber = "0987654321",
                            Role = "Customer",
                            Username = "CuongUser"
                        },
                        ...
                        {
                            UserID = 10,
                            CreatedAt = new DateTime(2025, 2, 13, 23, 34, 15, 514, DateTimeKind.Local).AddTicks(7197),
                            Email = "AnhVNHE151076@fpt.edu.vn",
                            FullName = "Vũ Nam Anh",
                            IsFreeShip = false,
                            PasswordHash = "$2a$11$5Lw9I5JORgY5f2tZI5DdDOLQR3ExNSvb6rxIYWG8novbdIXswoseG",
                            PhoneNumber = "0123456789",
                            Role = "Customer",
                            Username = "AnhUser"
                        });
